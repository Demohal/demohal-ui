...
export default function Welcome() {
  ...
  const [bannerUrl, setBannerUrl] = useState(""); // Banner image URL from bot settings
  const [useBannerUrl, setUseBannerUrl] = useState(false); // Whether to use banner image
        ...
        >
          {useBannerUrl && bannerUrl && websiteUrl ? (
            <a
              ...
              className="block focus-visible:ring-2 focus-visible:ring-white/60 rounded outline-none"
              title="Visit website"
